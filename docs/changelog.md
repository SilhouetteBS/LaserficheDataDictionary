...
- Static product/version data model
- Tables, compare, diagram, objects, impact, health, dependencies, and reporting views
- Public read-only warning
- Optional local editing mode for internal documentation review
