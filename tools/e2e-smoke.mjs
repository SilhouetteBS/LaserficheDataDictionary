...
assert.equal(await page.getByRole('button', { name: 'Snapshot details', exact: true }).getAttribute('aria-expanded'), 'false');
...
assert.match(await page.locator('.snapshot-details').innerText(), /Export manifest and snapshot coverage/i);
